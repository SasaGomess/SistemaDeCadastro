...
public class BuscarPet implements BuscarPetInterface {
    ...
    @Override
    public void buscandoPet(List<Pet> list, Pet pet) {
        ...
        do{
            if (criterios == 1){
                BuscarPorUmCriterio.buscandoPorUmCriterio(scanner, resultBusca);
            }else {
                buscandoDoisCriterios.buscandoDoisCriterios(scanner, resultBusca);
            }
